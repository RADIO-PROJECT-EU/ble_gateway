...
import org.atlas.wsn.ble.impl.BluetoothLeScanner;
import org.atlas.wsn.ble.beacon.BluetoothAdvertisingData;
import org.atlas.wsn.ble.beacon.BluetoothConfigurationProcessListener;
...
public class BluetoothAdapterImpl implements BluetoothAdapter {
    ...
    public BluetoothAdapterImpl(String name) throws WsnException {
        this.m_name = name;
        this.m_bbcl = null;
        buildAdapter(name);
    }

    public BluetoothAdapterImpl(String name, BluetoothBeaconCommandListener bbcl) throws WsnException {
        this.m_name = name;
        this.m_bbcl = bbcl;
        buildAdapter(name);
    }
    ...
    //
    // --------------------------------------------------------------------
    private void buildAdapter(String name) throws WsnException {
